...
const Post = () => {
  ...
  //influencer approve/unapprove campaign
    ...
    if (state.user.id == campaign.channels[0].user) {
      ...
      return (
        <div className="form-button">
          ...
          <Button color="primary" onClick={() => handleEmployeeApproval(true)}>
            Xác nhận
          </Button>
        </div>
      );
                            ...
                            <TimelineItem>
                              ...
                              <TimelineContent>
                                <Paper elevation={3} className={classes.paper}>
                                  <p>Kiểm duyệt</p>
                                  <CardText>
                                    Hệ thống TrendZ đang xử lý yêu cầu
                                  </CardText>
                                </Paper>
                              </TimelineContent>
                            </TimelineItem>
                            ...
                            <TimelineItem>
                              ...
                              <TimelineContent>
                                <Paper elevation={3} className={classes.paper}>
                                  ...
                                  <p>
                                    Hệ thống TrendZ đã từ chối yêu cầu
                                  </p>
                                </Paper>
                              </TimelineContent>
                            </TimelineItem>
